...
const Waitlist = () => {
    ...
    return(
        <div className=" lg:flex w-full lg:h-[781px]">
...

                {
                    showodal? (
                        <div className=" fixed lg:fixed inset-0 flex justify-center">
                            <div className=" overflow-y-auto px-[16px] w-[342px] h-[100%] lg:px-[45px] bg-[#F2F6FF] lg:w-[1104px] lg:h-[644px] rounded-[32px] font-urbanist">
