...
const Waitlist = () => {
    ...
    return(
        <div className=" lg:flex ">
            ...
            <div className=" lg:min-h-fit lg:w-[62%] xl:flex-grow lg:pt-40 xl:pt-40 pt-10 bg-[#001F6D] flex justify-center">
                <div className=" w-full lg:w-[448px] text-[#FFFFFF] flex flex-col gap-[48px]">
                    ...
                    <form className=" flex flex-col gap-[48px]">
                        ...
                        <div>
                            ...
                            <button onClick={() => setShowSubmit(true)} className=" cursor-pointer w-[186px] text-[18px] rounded-[8px] lg:w-[292px] bg-[#DA0025] p-[16px] text-center">Join our waitlist</button>
                            </div>
                        </div>
                </form>
...

                {
                    showodal? (
                        <div className=" fixed inset-0 flex justify-center">
                            <div className=" overflow-y-auto px-[16px] w-[342px] h-[100%] lg:px-[35px] xl:px-[45px] bg-[#F2F6FF] lg:w-[1024px] xl:w-[1104px] lg:h-[644px] rounded-[32px] font-urbanist">
                                <div onClick={()=>setShowModal(false)} className=" cursor-pointer text-[20.4px] font-bold mt-[62px] flex justify-end">X</div>
                                <div className=" flex flex-col lg:flex-row lg:flex lg:gap-[32px]">
                                    <div className=" flex flex-col gap-[24px]">
                                        <div className=" w-[310px] flex flex-col gap-[16px] lg:w-[491px]">
